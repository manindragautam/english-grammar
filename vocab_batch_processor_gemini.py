...
# Using gemini-1.5-pro to act as an advanced model like Gemini 3.1 Pro (High) equivalent available via API
...
def run_gemini_batch(batch):
    """Sends words to Gemini and parses Dissection, Meaning, Hindi, and Examples."""
...
"""
    ...
    try:
        ...
        # Optional: apply clean_ansi if output could have ANSI codes (rare from Gemini but safe)
...
def process_file(filepath, progress):
    ...
    llm_results = run_gemini_batch(batch)
